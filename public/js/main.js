(function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
          ...
          getVideos: function getVideos() {
              this.$http.get('/api/videos' + this.$route.path).then(function (response) {
                  ...
                  if (this.$route.params.name != null) {
                      ...
                      this.$set('nameRoute', 'Alle Videos');
                  }
              });
          }
      }
  ...
  "use strict";
  if (module.exports.__esModule) module.exports = module.exports.default
  ;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<div id=\"sidebar-wrapper\">\n    <ul class=\"sidebar-nav\">\n        <li><a href=\"/upload\"><span class=\"glyphicon glyphicon-upload\"></span> Upload</a></li>\n        <li><a v-link=\"{ path: '/category/Reportage' }\"><span class=\"glyphicon glyphicon-film\"></span> Reportage</a></li>\n        <li><a v-link=\"{ path: '/category/Muziek' }\"><span class=\"glyphicon glyphicon-headphones\"></span> Muziek</a></li>\n        <li><a v-link=\"{ path: '/category/Sport' }\"><i class=\"fa fa-futbol-o\" aria-hidden=\"true\"></i> Sport</a></li>\n        <li><a v-link=\"{ path: '/category/Games' }\"><i class=\"fa fa-gamepad\" aria-hidden=\"true\"></i> Games</a></li>\n        <li><a v-link=\"{ path: '/category/Overige' }\"><i class=\"fa fa-video-camera\" aria-hidden=\"true\"></i> Overige</a></li>\n        <li><a v-link=\"{ path: '/best' }\"><i class=\"fa fa-line-chart\" aria-hidden=\"true\"></i> Alle Videos</a></li>\n </ul>\n</div>\n\n"
  if (module.hot) {(function () {  module.hot.accept()
    var hotAPI = require("vue-hot-reload-api")
    hotAPI.install(require("vue"), true)
    if (!hotAPI.compatible) return
